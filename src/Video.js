...
function VideoInfo(props){
  ...
  return (<>
    ...
    <div class="video-desc">
      ...
      <p>YouTube descriptions, including all the right elements like informative text, links, buttons, and timestamps, can help viewers discover your videos, and increase your subscribers, views, watch time, and more.
      </p>
    </div>
  </>)
}
